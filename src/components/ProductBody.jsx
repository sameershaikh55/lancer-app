...
const ProductBody = () => {
	return (
		<>
			...
			{/* MOBILE FOOTER START */}
			<div className="footerPM_container position-relative d-flex justify-content-center align-items-center">
				<div>
					<div className="text-center">
						<p className="small text-dark mb-1 fw500">lancercomposites@gmail.com</p>
			...
			<div className="mFooter py-3 d-flex justify-content-end px-3">
